...
function Login(props) {
	...
	return (
			...
			>
			  ...
			  <Modal.Content image>
				<Image size='medium' src='https://coursereport-s3-production.global.ssl.fastly.net/uploads/school/logo/8/original/flatironschool.png' wrapped />
				<Modal.Description>
					{!isLoggedIn ? <Form onSubmit={handleLogInAttempt}>
						<Form.Field>
							<label>First Name</label>
							<input onChange={(e) => setUserNameInput(e.target.value)} placeholder='First Name' />
						</Form.Field>
						<Form.Field>
